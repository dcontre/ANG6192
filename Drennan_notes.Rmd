...
Complex analyses can be vital means of developing insights and testing ideas, but often simple reorganization and visualization of data are at least as useful. Particularly for the former, *tidyverse* tools are efficient and flexible (if sometimes reliant on syntax that is difficult to decipher). Even as you add additional analytical methods to your toolbox, you may want to revisit the notes on [Data Wrangling for Archaeology](https://dcontre.github.io/Rchaeology/introduction.html) and plotting (using both [Base R](###add link###) and [ggplot](###add link###)). There are *many* guides available to using R for data visualization; a good place to start is Joe Roe's slides on [*Data Visualization for Archaeologists in R*](https://joeroe.io/r4r_visualisation/r4r_visualisation_slides.html#1). 
